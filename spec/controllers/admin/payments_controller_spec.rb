...
RSpec.describe Admin::PaymentsController, type: :controller do
  ...
  describe "GET #index" do
    it "returns a success response" do
      Admin::Payment.create! valid_attributes
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Admin::Payment" do
        expect {
          post :create, params: {admin_payment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {admin_payment: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_payment" do
        payment = Admin::Payment.create! valid_attributes
        put :update, params: {id: payment.to_param, admin_payment: new_attributes}, session: valid_session
        payment.reload
      ...
      it "redirects to the admin_payment" do
        payment = Admin::Payment.create! valid_attributes
        put :update, params: {id: payment.to_param, admin_payment: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        payment = Admin::Payment.create! valid_attributes
        put :update, params: {id: payment.to_param, admin_payment: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
